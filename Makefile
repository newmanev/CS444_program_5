...
ULIB = ulib.o usys.o printf.o umalloc.o benny_thread.o
...
# when you have our threads working, you will need to change this to a higher number.
...
qemu-nox-gdb gnox: fs.img xv6.img .gdbinit
	@echo "*** Now run 'gdb'." 1>&2
